 ...
 *
 * เคสอุบัติเหตุ ตัดออกด้วยเหตุผลต่างออกไป: ไม่ได้ซ้ำโดยธรรมชาติ แต่รถชน
 * ซ้ำในรอบ 30 วันสะท้อนการขับขี่ ไม่ใช่คุณภาพงานซ่อม ซึ่งเป็นสิ่งที่ KPI
 * ตัวนี้วัด
 */
export const NATURAL_REPEAT_TYPES = [
  ...
  // ── ชื่อชุดใหม่ ─────────────────────────────────────────────────────────
  // ATMS กำลังย้ายไปใช้ชื่อแบบ "อู่ใน-/อู่นอก- <หมวด> - <งาน>" ตั้งแต่ราว
  // ส.ค. 2026 ชื่อเดิมยังใช้อยู่คู่กัน ทั้งสองชุดจึงต้องอยู่ในลิสต์นี้ทั้งคู่
  // ไม่งั้นงานเดียวกันจะถูกตัดออกหรือไม่ถูกตัด ขึ้นกับว่าใบนั้นตั้งชื่อแบบไหน
  //
  // ตัดด้วยชื่อตรงตัว ไม่ใช่ pattern — "ยางรองแท่นเครื่อง" เป็นงานซ่อมจริง
  // regex ที่จับคำว่า "ยาง" จะกินไปด้วย
  //
  // เจอชื่อใหม่ที่ขึ้นต้น อู่ใน-/อู่นอก- แล้วเป็นงาน PM / T / ทำความสะอาด /
  // อัดจารบี / วัสดุสิ้นเปลือง / อุปกรณ์เสริม ให้เติมที่นี่
  "ปะยาง",
  "อู่ใน-T-เปลี่ยนยาง",
  "อู่นอก-T-เปลี่ยนยาง",
  ...
  "อู่นอก-PM-3",
  "อู่นอก-PM-ช่วงล่าง",
  "อู่นอก-PM-ระบบความเย็น",
  "อู่นอก-PM-ลิฟต์ท้าย",

  "เคสอุบัติเหตุ",
  "อู่ใน-AC-เคสอุบัติเหตุ",
  "อู่นอก-AC-เคสอุบัติเหตุ",
]
